 ...
 *=========================================================================*/
/*
  This is a modified version of itkInvertDisplacementFieldImageFilter.h
*/
#ifndef itkModifiedInvertDisplacementFieldImageFilter_h
#define itkModifiedInvertDisplacementFieldImageFilter_h
...
/**
 * \class ModifiedInvertDisplacementFieldImageFilter
 *
...
class ITK_TEMPLATE_EXPORT ModifiedInvertDisplacementFieldImageFilter
    : public ImageToImageFilter<TInputImage, TOutputImage> {
   public:
    ITK_DISALLOW_COPY_AND_MOVE(ModifiedInvertDisplacementFieldImageFilter);

    using Self = ModifiedInvertDisplacementFieldImageFilter;
    ...
    itkTypeMacro(ModifiedInvertDisplacementFieldImageFilter, ImageToImageFilter);
     ...
     */
    const InputFieldType *GetDisplacementField() const { return this->GetInput(0); }
   ...
   protected:
    /** Constructor */
    ModifiedInvertDisplacementFieldImageFilter();

    /** Deconstructor */
    ~ModifiedInvertDisplacementFieldImageFilter() override = default;
...
#include "itkModifiedInvertDisplacementFieldImageFilter.hxx"
#endif
